  ...
  function init(root) {
    ...
    function compute() {
      ...
      return {
        ...
        routineDaily: arch.routineDaily || '',
        routineTravel: arch.routineTravel || '',
        mk: mk, sk: sk, hc: hc
      };
    }
    ...
    function renderResult(result) {
      ...
      var whyTexts = [result.descMakeup, result.descSkincare, result.descHaircare, result.routineDaily, result.routineTravel];
